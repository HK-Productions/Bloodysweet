...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://New:New@cluster0.29hkq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")

DATABASE_NAME = environ.get('DATABASE_NAME', "Safari")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telefiles')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002119063158'))
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/AYP.jpg')
START_IMG = environ.get('START_IMG', 'https://envs.sh/5Hq.jpg')
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002119063158'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002119063158'))
URL = environ.get('URL', 'af_mhakal')
STICKERS_IDS = ('CAACAgQAAxkBAAEK99dlfC7LDqnuwtGRkIoacot_dGC4zQACbg8AAuHqsVDaMQeY6CcRojME').split()
FILE_AUTO_DEL_TIMER = int(environ.get('FILE_AUTO_DEL_TIMER', '600'))
IS_VERIFY = is_enabled('IS_VERIFY', True)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002374491423'))
